...
exports.ClarifyViewProvider = void 0;
const vscode = __importStar(require("vscode"));
const node_fetch_1 = __importDefault(require("node-fetch"));
class ClarifyViewProvider {
    constructor() {
        this._log = [];
    }
        ...
        view.webview.onDidReceiveMessage(async (msg) => {
            if (msg.type === 'analyze') {
                ...
                try {
                    ...
                    const resp = await (0, node_fetch_1.default)(`${baseUrl}/v1/dialogue`, {
                    ...
                    for (const r of replies) {
                        this._log.push({ role: r.role, content: r.content });
                    }
                ...
                try {
                    ...
                    const resp = await (0, node_fetch_1.default)(`${baseUrl}/v1/generate_code`, {
                        method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(body)
                    });
                    const data = await resp.json();
                ...
                const baseUrl = cfg.get('serviceUrl', 'https://api.clarifycoder.pappuraj.com');
                try {
                    const resp = await (0, node_fetch_1.default)(`${baseUrl}/v1/summarize_findings`, {
                ...
                const baseUrl = cfg.get('serviceUrl', 'https://api.clarifycoder.pappuraj.com');
                try {
                    const resp = await (0, node_fetch_1.default)(`${baseUrl}/v1/memory?project_id=default`);
                    const data = await resp.json();
                ...
                const baseUrl = cfg.get('serviceUrl', 'https://api.clarifycoder.pappuraj.com');
                try {
                    const resp = await (0, node_fetch_1.default)(`${baseUrl}/v1/memory`, {
...
exports.ClarifyViewProvider = ClarifyViewProvider;
ClarifyViewProvider.viewType = 'clarifycoder.panel';
